...
BaseFormatPanel.prototype.addUnitInput = function(container, unit, right, width, update, step, marginTop, disableFocus, isFloat)
{
	...
	container.style.padding='10px 0px 35px 18px';
...
ArrangePanel.prototype.addAngle = function(div)
{
	...
	if (ss.rotatable && !ss.table && !ss.row && !ss.cell)
	{
		...
		input = this.addUnitInput(div, '°', 20,35, function()
		{
...
ArrangePanel.prototype.addGeometry = function(container)
{
	...
	var width = this.addUnitInput(div, this.getUnit(), 84, 35, function()
	{
		widthUpdate.apply(this, arguments);
	}, this.getUnitStep(), null, null, this.isFloatUnit());
	var height = this.addUnitInput(div, this.getUnit(), 20, 35, function()
	{
	...
	var left = this.addUnitInput(div2, this.getUnit(), 84, 35, function()
	{
		leftUpdate.apply(this, arguments);
	}, this.getUnitStep(), null, null, this.isFloatUnit());
	var top = this.addUnitInput(div2, this.getUnit(), 20, 35, function()
	{
...
ArrangePanel.prototype.addEdgeGeometry = function(container)
{
	...
	var width = this.addUnitInput(div, 'pt', 20, 35, function()
	{
		widthUpdate.apply(this, arguments);
	});
	...
	var xs = this.addUnitInput(divs, 'pt', 84,35, function()
	{
		xsUpdate.apply(this, arguments);
	});
	var ys = this.addUnitInput(divs, 'pt', 20, 35, function()
	{
	...
	var xt = this.addUnitInput(divt, 'pt', 84,35, function()
	{
		xtUpdate.apply(this, arguments);
	});
	var yt = this.addUnitInput(divt, 'pt', 20, 35, function()
	{
...
TextFormatPanel.prototype.addFont = function(container)
{
	...
	stylePanel4.style.paddingTop = '12px';
	stylePanel4.style.paddingBottom = '12px';
	...
	stylePanel5.style.paddingTop = '12px';
	stylePanel5.style.paddingBottom = '12px';
...
StyleFormatPanel.prototype.init = function()
{
	...
	if (!ss.containsLabel && ss.cells.length > 0)
	{
		...
		opacityPanel.style.paddingBottom = '20px';
...
StyleFormatPanel.prototype.addStroke = function(container)
{
	...
	perimeterPanel.style.paddingTop = '6px';
	var span = document.createElement('div');
	span.style.position = 'absolute';
	span.style.marginLeft = '3px';
	span.style.marginBottom = '12px';
