...
function Sidebar(editorUi, container)
{
	...
	mxEvent.addListener(container, 'scroll', mxUtils.bind(this, function()
	{
		...
		//adding templates div
		//outer 
	var temp_outer= document.createElement('div');
	temp_outer.className = 'tempOuter';
	temp_outer.style.boxSizing = 'border-box';
	temp_outer.style.overflow = 'hidden';
	temp_outer.style.width = '100%';
	temp_outer.style.padding = '7px 0px';

	this.container.appendChild(temp_outer);
	
	//link
				var templink = document.createElement('a');
			    templink.id='templateLink';
				templink.className = 'geTitle';
				templink.style.cssText = 'background-color:#0057BB;color:white;' +
					'white-space:normal;font-size:15px;font-weight:600;cursor:pointer;';
			  templink.innerHTML = "Templates";
			  temp_outer.appendChild(templink);
			  
//click event
		mxEvent.addListener(templink, 'click', mxUtils.bind(this, function(evt)
		{
			...
			editorUi.showDialog(dlg.container, (compact) ? 350 : 620, (compact) ? 70 : 460, true, true, function(cancel)
			{
				...
				if (cancel)
				{
					               //editorUi.showSplash();
									...
									document.getElementById("appModalTxt").innerHTML="&#8505;&nbsp;You should not proceed without a template!";
...
Sidebar.prototype.addGeneralPalette = function(expand)
{
	...
	//this.addPaletteFunctions('general', mxResources.get('general'), (expand != null) ? expand : false, fns);
	this.setCurrentSearchEntryLibrary();
};
...
Sidebar.prototype.addMiscPalette = function(expand)
{
	...
	var fns = [
   	 	this.createVertexTemplateEntry('text;strokeColor=none;fillColor=none;html=1;fontSize=24;fontStyle=1;verticalAlign=middle;align=center;', 100, 40, 'Title', 'Title mine', null, null, 'text heading title'),
...
Sidebar.prototype.addAdvancedPalette = function(expand)
{
	...
	this.addPaletteFunctions('advanced', mxResources.get('advanced'), (expand != null) ? expand : true, this.createAdvancedShapes());
	this.setCurrentSearchEntryLibrary();
};
