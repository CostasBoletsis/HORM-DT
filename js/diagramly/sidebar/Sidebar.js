...
//function for titles
function get_title_array(field){
	const titles=[]
		for (let i = 0; i < field.length; i++) {
			new_title=field[i].replaceAll('-', ' ').trim();
			titles.push(new_title.charAt(0).toUpperCase()+ new_title.slice(1).toLowerCase());
	}
	return titles;
}
		
        var health=["health-secretary-2",
"hospital-1",
"hospital-2",
"hospital-3",
"hospital-4",
...
var cyber_sec=["attacker",
"attacker-network",
"attacker-physical",
"attacker-socialengineering",
"attacker-software",
"cyber-security-expert1",
"cyber-security-expert2",
"cyber-security-expert3",
"cyber-security-expert4",
"cyber-security-expert5",
"cyber-security-expert6",
"cyber-security-expert7",
"cyber-security-expert8",
"cyber-security-expert9",
"special-danger1",
"special-danger2",
"special-firewall",
"special-unwanted-incident",
"special-vulnerability-lock",
"special-vulnerability-unlock",
"special-threat"
];
var actors=["bank1-online",
"bank2-online",
"bank3",
"bank4",
"bank5",
...
"internet-via-pc-2",
"internet-via-pc-3",
"internet-via-smartphone-1",
"internet-via-smartphone-2",
"internet-via-smartphone-3",
"internet-via-tablet-1",
"internet-via-tablet-2",
"internet-via-tablet-3",
"invoice-1",
"invoice-2",
"invoice-3",
"invoice-4",
...
"pc",
"phone",
"self-service-machine-1",
"self-service-machine-2",
"self-service-machine-3",
"service-desk-1",
"service-desk-2",
"shop-counter-1",
"shop-counter-2",
...
"very-unsatisfied"
		...
		this.setCurrentSearchEntryLibrary('clip_art', 'actors');
		this.addImagePalette('cjml', 'Actors', imgDir
				+ '/lib/clip_art/cjml/general/actors/', '.svg', actors,get_title_array(actors));
		this.setCurrentSearchEntryLibrary('clip_art', 'communication');
				this.addImagePalette('cjml', 'Communication channels', imgDir
				+ '/lib/clip_art/cjml/general/communication/', '.svg', comm, get_title_array(comm));
		this.setCurrentSearchEntryLibrary('clip_art', 'experience');
		this.addImagePalette('cjml', 'Customer experience', imgDir
				+ '/lib/clip_art/cjml/general/customerexp/', '.svg', cus_exp,get_title_array(cus_exp));
						this.addImagePalette('cjml', 'Health', imgDir
				+ '/lib/clip_art/cjml/health/', '.svg', health,get_title_array(health));
				this.addImagePalette('cjml', 'Cyber security', imgDir
				+ '/lib/clip_art/cjml/cybersec/', '.svg', cyber_sec, get_title_array(cyber_sec));
	...
	Sidebar.prototype.itemClicked = function(cells, ds, evt)
	{
		...
		var handled = false;
		//when sidebar icons are clicked
		cells[0].geometry.height=40;
		cells[0].geometry.width=40;
