...
//	});
	...
	tmplSearchInput.style.cssText = 'width:118px;height:16px;border:1px solid #d3d3d3;padding: 3px 20px 3px 3px;font-size: 12px';
	...
	list.style.cssText = 'position:absolute;left:30px;width:128px;top:128px;bottom:68px;margin-top:6px;overflow:auto;';
