...
(function()
{
	...
	Menus.prototype.init = function()
	{
		...
		editorUi.actions.addAction('support...', function()
		{
			...
			{
				editorUi.openLink('https://www.sintef.no/en/all-employees/employee/4146/');
			}
			else
			{
				editorUi.openLink('https://www.sintef.no/en/all-employees/employee/4146/');
			}
		}).label = 'Contact Details for Support...';
		...
		editorUi.actions.addAction('credits', function()
		{
			
		}).label = 'This Tool is Developed Using...';
		
			editorUi.actions.addAction('cc', function()
		{
			editorUi.openLink('https://creativecommons.org/licenses/by-sa/4.0/');
		}).label = '... and is Distributed Under the CC BY-SA 4.0 License';
		
			editorUi.actions.addAction('jgraph', function()
		{
			editorUi.openLink('https://github.com/jgraph/');
		}).label = '• JGraph Diagramming Application';
		
		editorUi.actions.addAction('CJML', function()
		{
			editorUi.openLink('https://cjml.no/');
		}).label = '• CJML Modelling Language';
		
		this.put('help', new Menu(mxUtils.bind(this, function(menu, parent)
		{
			if (!mxClient.IS_CHROMEAPP && editorUi.isOffline())
			{
				this.addMenuItems(menu, ['credits'], parent);
			}
			else
			{
				...
				if (EditorUi.isElectronApp)
				{
					...
					this.addMenuItems(menu, ['keyboardShortcuts', 'quickStart',
						'support', '-', '-', 'credits'], parent);

				}
				else
				{
					this.addMenuItems(menu, ['-', 'keyboardShortcuts', 'quickStart',
						'support', '-', 'credits','CJML','jgraph', 'cc'], parent);
